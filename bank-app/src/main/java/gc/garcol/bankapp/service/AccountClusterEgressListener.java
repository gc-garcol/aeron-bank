...
public class AccountClusterEgressListener implements EgressListener {
  ...
  public void onSessionEvent(long correlationId, long clusterSessionId, long leadershipTermId,
    ...
    EgressListener.super.onSessionEvent(correlationId, clusterSessionId, leadershipTermId,
  ...
  public void onNewLeader(long clusterSessionId, long leadershipTermId, int leaderMemberId,
    ...
    EgressListener.super.onNewLeader(clusterSessionId, leadershipTermId, leaderMemberId,
        ingressEndpoints);
  }

  @Override
  public void onAdminResponse(long clusterSessionId, long correlationId,
      AdminRequestType requestType, AdminResponseCode responseCode, String message,
      DirectBuffer payload, int payloadOffset, int payloadLength) {
    EgressListener.super.onAdminResponse(clusterSessionId, correlationId, requestType, responseCode,
        message, payload, payloadOffset, payloadLength);
  }
}
